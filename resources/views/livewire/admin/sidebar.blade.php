        ...
        <div class="py-4 text-gray-500 dark:text-gray-400">
            ...
            <ul>
                @can('manageTaskPriorities')
                    <li class="relative px-6 py-3 {{ request()->is('priorities*') ? 'text-gray-800 dark:text-gray-200 bg-gray-100 dark:bg-gray-700' : 'text-gray-500 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200' }}"">
                        <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
