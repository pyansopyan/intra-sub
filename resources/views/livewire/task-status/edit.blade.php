<div>
    ...
    <div class="p-6 bg-white shadow rounded-lg dark:bg-gray-800">
        <form wire:submit.prevent="update">
            ...
            <div class="mb-4">
                <label for="name" class="block text-sm font-medium text-gray-700 dark:text-gray-400">Status Name</label>
             ...
             <div class="mb-4">
                <label for="color" class="block text-sm font-medium text-gray-700 dark:text-gray-400">Status Color</label>
            ...
            <div class="mb-4 flex items-center">
                ...
                <label for="is_default" class="ml-2 block text-sm text-gray-900 dark:text-gray-400">Default Status</label>
            </div>

            <div class="mb-4">
                <label for="order" class="block text-sm font-medium text-gray-700 dark:text-gray-400">Status Order</label>
