<div>
    ...
    <div class="container px-6 mx-auto grid">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4">
                    ...
                    <div class="grid grid-cols-7 gap-1 text-center">
                        ...
                        @foreach ($calendar as $week)
                            ...
                            {{ $date['isCurrentMonth'] ? 'bg-gray-100 dark:bg-gray-700' : 'bg-gray-200 dark:bg-gray-600' }}
                            {{ $date['isToday'] ? 'text-white font-bold bg-blue-500' : 'text-gray-700 dark:text-gray-200' }}">
                                    {{ $date['day'] }}
                                </div>
                            @endforeach
                        @endforeach
        ...
        <div class="w-full overflow-hidden rounded-lg shadow-xs">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center text-sm">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-black-600 dark:text-black-400">
                                            10x Developer
                                        </p>
                                    </div>
                                </div>
            ...
            <div
                class="grid px-4 py-3 text-xs font-semibold tracking-wide text-black-500 uppercase border-t dark:border-gray-700 bg-gray-50 sm:grid-cols-9 dark:text-black-400 dark:bg-gray-800">
