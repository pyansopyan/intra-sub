<div class="container mx-auto mt-4">
    ...
    <form wire:submit.prevent="store">
        ...
        <div class="mb-5">
            ...
            <input id="name" name="name" type="text" placeholder="Masukan Name" autocomplete="off" wire:model="name" required
        ...
        <div class="flex space-x-4">
            ...
            <a href="{{ route('jabatan.index') }}" class="bg-gray-500 hover:bg-gray-600 text-white font-semibold py-2 px-5 rounded-md transition duration-300">
                Kembali
            </a>
        </div>
    </form>
