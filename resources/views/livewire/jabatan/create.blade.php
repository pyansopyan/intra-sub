<div>
     <div class="breadcrumbs text-sm mt-4">
        <ul>
            ...
            <li><a class="text-black-400 font-semibold">Tambah data Jabatan</a></li>
        </ul>
    </div>
    ...
    <form wire:submit.prevent="store">
        ...
        <button type="submit" class="btn btn-md btn-primary text-black hover:text-white dark:text-white">Simpan</button>
    </form>
</div>
