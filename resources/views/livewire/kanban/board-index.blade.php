<div>
    ...
    <div class="flex justify-center mb-4">
        <div class="p-6 rounded-lg shadow-md max-w-2xl dark:bg-gray-800 bg-white w-full">
            ...
            <select wire:model="selectedProject" id="project" class="w-full p-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 bg-white rounded-lg focus:ring-purple-500 focus:border-purple-500">
