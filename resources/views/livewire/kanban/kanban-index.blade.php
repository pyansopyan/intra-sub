    ...
    <div class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
        <div class="bg-white p-6 rounded-lg w-1/2 relative">
            ...
            <div class="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div class="col-span-1">
                    <label for="name" class="block text-sm font-medium text-gray-700">Task Name</label>
                    <input id="name" type="text" wire:model="newTask.name" placeholder="Enter task name" class="bg-gray-100 p-2 rounded w-full" />
                </div>

                <!-- Content -->
                <div class="col-span-1">
                    <label for="content" class="block text-sm font-medium text-gray-700">Content</label>
                    <textarea id="content" wire:model="newTask.content" placeholder="Enter task content" class="bg-gray-100 p-2 rounded w-full"></textarea>
                </div>
                ...
                <div class="col-span-1">
                    ...
                    <select id="responsible_id" wire:model="newTask.responsible_id" class="bg-gray-100 p-2 rounded w-full">
               ...
               <div class="col-span-1">
                ...
                <div class="col-span-1">
                    ...
                    <select id="priority_id" wire:model="newTask.priority_id" class="bg-gray-100 p-2 rounded w-full">
                ...
                <div class="col-span-1">
                    ...
                    <input id="code" type="text" wire:model="newTask.code" placeholder="Enter Code" class="bg-gray-100 p-2 rounded w-full" />
                </div>

                <!-- Order -->
                <div class="col-span-1">
                    <label for="order" class="block text-sm font-medium text-gray-700">Order</label>
                    <input id="order" type="number" wire:model="newTask.order" placeholder="Enter Order" class="bg-gray-100 p-2 rounded w-full" />
                </div>

                <!-- Estimation -->
                <div class="col-span-1">
                    <label for="estimation" class="block text-sm font-medium text-gray-700">Estimation</label>
                    <input id="estimation" type="number" wire:model="newTask.estimation" placeholder="Enter Estimation" class="bg-gray-100 p-2 rounded w-full" />
                </div>
