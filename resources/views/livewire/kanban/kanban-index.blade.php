<div>
    ...
    <div class="flex space-x-4">
        @foreach ($statuses as $status)
            <div
                class="w-1/3 text-white p-4 mt-4 rounded shadow-2xl"
        ...
        <div class="bg-white p-6 rounded-lg w-1/2 relative">
            ...
            <div class="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div class="col-span-1">
                    ...
                    <select
                        id="owner_id"
                        wire:model="editedTask.owner_id"
                        class="bg-gray-100 p-2 rounded w-full"
                        wire:keyup="updateTaskRealTime"
                    >
                ...
                <div class="col-span-1">
                    ...
                    <input
                        type="date"
                        id="start-date"
                        wire:model="editedTask.start_date"
                        class="bg-gray-100 p-2 rounded w-full"
                    />
                </div>
                ...
                <div class="col-span-1">
                    ...
                    <input
                        type="date"
                        id="end-date"
                        wire:model="editedTask.end_date"
                        class="bg-gray-100 p-2 rounded w-full"
                    />
                </div>
                ...
                <div class="col-span-1">
                    ...
                    <select
                        id="responsible_id"
                        wire:model="editedTask.responsible_id"
                        class="bg-gray-100 p-2 rounded w-full"
                        wire:keyup="updateTaskRealTime"
                    >
                ...
                <div class="col-span-1">
                    ...
                    <select
                        id="priority_id"
                        wire:model="editedTask.priority_id"
                        class="bg-gray-100 p-2 rounded w-full"
                        wire:keyup="updateTaskRealTime"
                    >
                ...
                <div class="col-span-1">
                    ...
                    <input
                        id="estimation"
                        type="number"
                        wire:model="editedTask.estimation"
        ...
        <div class="bg-white p-6 rounded-lg w-1/2 relative">
            ...
            <div class="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div class="col-span-1">
                    ...
                    <select
                        id="responsible_id"
                        wire:model="newTask.responsible_id"
                        class="bg-gray-100 p-2 rounded w-full"
                    >
                        <option value="">Select Responsible</option>
                        @foreach ($responsibles as $responsible)
                ...
                <div class="col-span-1">
                    ...
                    <select
                        id="priority_id"
                        wire:model="newTask.priority_id"
                        class="bg-gray-100 p-2 rounded w-full"
                    >
                        <option value="">Select Priority</option>
                        @foreach ($priorities as $priority)
