<div>
    <div class="breadcrumbs text-sm mt-4">
        <ul>
            ...
            <li><a href="{{ route('activities.index') }}" class="text-gray-400 font-semibold">Activities</a></li>
        </ul>
    </div>
    ...
    <div class="w-full overflow-hidden rounded-lg shadow-xs">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center space-x-4 text-sm">
                                    @can('manageActivities-edit')
                                        <a href="{{ route('activities.edit', $aktiv->id) }}"
                                    ...
                                    @endcan
                                    @can('manageActivities-view')
                                        <a href="{{ route('activities.show', $aktiv->id) }}"
                                    ...
                                    @endcan
                                    @can('manageActivities-delete')
                                        <button onclick="my_modal_{{ $aktiv->id }}.showModal()"
        ...
        <div class="mt-8 mb-6 p-1 flex justify-between items-center">
            <div class="text-sm text-gray-500">
                Showing {{ $aktivitas->firstItem() }} to {{ $aktivitas->lastItem() }} of {{ $aktivitas->total() }} entries
            </div>
